...
const data: IProjectCategory = {
    ...
    text: {
        ...
        he: 'מחקרי מקרה המחברים בין חזון רעיוני לישימות בפרויקטים פוטנציאליים. סיכום תהליכים אנליטיים, בחינת היבטים משפטיים, רגולטוריים, פיננסיים והקשריים לבחינה מעמיקה של יוזמות חדשות.',
    },
    stripIndex: 1,
    projects: []
};
